...
import { technicalReducer } from '../states/technical'
...
export const technicalPersistConfig = {
  key: 'technical',
  storage
}
...
export const persistedTechnicalReducer = persistReducer(technicalPersistConfig, technicalReducer)

...
class RecordSerializer(UUIDMixin, serializers.Serializer):
    ...
    first_name = serializers.CharField(max_length=NAMES_LEN, required=False, allow_blank=True, allow_null=True)
    surname = serializers.CharField(max_length=NAMES_LEN, required=False, allow_blank=True, allow_null=True)
    last_name = serializers.CharField(max_length=NAMES_LEN, required=False, allow_blank=True, allow_null=True)
    car_number = serializers.CharField(required=False, allow_blank=True, allow_null=True)
    car_brand = serializers.CharField(required=False, allow_blank=True, allow_null=True)
    car_model = serializers.CharField(required=False, allow_blank=True, allow_null=True)

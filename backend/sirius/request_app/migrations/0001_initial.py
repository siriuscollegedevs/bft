    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(default=timezone.now)),
                ('action', models.CharField(choices=[('deleted', 'Удалена'), ('canceled', 'Аннулирована'), ('outdated', 'Истек срок действия'), ('modified', 'Изменена'), ('created', 'Создана'), ('closed', 'Погашена')], max_length=10)),
                ('car_number', models.CharField(blank=True, max_length=60, null=True)),
                ('car_brand', models.CharField(blank=True, max_length=60, null=True)),
                ('car_model', models.CharField(blank=True, max_length=60, null=True)),

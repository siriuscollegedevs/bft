...
class RecordHistory(UUIDMixin, models.Model):
    ...
    car_model = models.CharField(max_length=NAMES_LEN, null=True, blank=True, default='')
    ...
    last_name = models.CharField(max_length=NAMES_LEN, null=True, blank=True, default='')

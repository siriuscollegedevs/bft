    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.CharField(choices=[('delited', 'Удален'), ('modified', 'Изменен'), ('created', 'Создан')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.CharField(choices=[('delited', 'Удален'), ('modified', 'Изменен'), ('created', 'Создан'), ('password_changed', 'Изменен пароль')], max_length=16)),

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('record', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='sirius_access.record', verbose_name='Заявка')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('virsion', models.IntegerField(default=0, validators=[sirius_access.models.is_positive], verbose_name='Версия')),
                ('name', models.CharField(max_length=40, verbose_name='Название')),
                ('timestamp', models.DateTimeField(auto_now_add=True, verbose_name='Действие совершено')),
                ('action', models.CharField(choices=[('delited', 'Удален'), ('modified', 'Изменен'), ('created', 'Создан')], max_length=10, verbose_name='Сщвершенное действие')),
                ('modified_by', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='sirius_access.account', verbose_name='Изменен пользователем')),
